...
// Returns { passed, results?, fatal?, error? }
//  - results: per-test { call, expected, actual?, passed, error? }
//  - fatal:   the user's code failed to load (syntax error etc.)
//  - error:   the runner itself failed (timeout, python missing)
